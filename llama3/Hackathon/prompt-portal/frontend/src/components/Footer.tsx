      ...
      <div style={containerStyle}>
        <div style={{
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, lineHeight: '1.8' }}>
              ...
              <li><i className="fas fa-check" style={{ marginRight: '8px', color: '#4ecdc4' }}></i>Real-time MQTT Communication</li>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
              {['Python', 'PyGame', 'PyTorch', 'React', 'TypeScript', 'MQTT'].map(tech => (
                <span key={tech} style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '0.9rem' }}>
            © 2025 LAM Maze Platform. Built for prompt engineering enthusiasts.
          </p>
