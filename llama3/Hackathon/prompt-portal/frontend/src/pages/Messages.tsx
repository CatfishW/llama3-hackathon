        ...
        const updated = prev.map(conv => 
          conv.user_id === message.sender_id
            ? {
                ...
                unread_count: conv.user_id === parseInt(userId || '0') ? 0 : conv.unread_count + 1
              }
            : conv
        )
        ...
        <div style={{ flex: 1, overflow: 'auto' }}>
          {loading ? (
            <div style={{ padding: '40px', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '0.9rem', opacity: '0.8' }}>Loading conversations...</p>
            </div>
          ) : conversations.length === 0 ? (
            <div style={{ padding: '40px', textAlign: 'center' }}>
              <i className="fas fa-comment-slash" style={{ fontSize: '2rem', marginBottom: '15px', opacity: '0.5' }}></i>
              <h4 style={{ marginBottom: '10px', fontSize: '1.1rem' }}>No conversations</h4>
              <p style={{ fontSize: '0.9rem', opacity: '0.7' }}>Start a conversation with your friends!</p>
            </div>
          ) : (
            conversations.map(conv => (
              <Link
                ...
                style={{
                  ...
                  background: conv.user_id === parseInt(userId || '0') 
                    ? 'rgba(78, 205, 196, 0.2)' 
                    : 'transparent',
      ...
      <div style={chatStyle}>
        {userId ? (
            ...
            <div style={{
              ...
              {messages.length === 0 ? (
                <div style={{
                  ...
                  <div>
                    <i className="fas fa-comment" style={{ fontSize: '3rem', marginBottom: '15px' }}></i>
                ...
                messages.map(message => (
                  <div
                    ...
                    style={{
                      display: 'flex',
                      flexDirection: 'column',
                      alignItems: message.sender_id === parseInt(userId) ? 'flex-end' : 'flex-start',
                      marginBottom: '15px'
                    }}
                  >
                    <div style={messageStyle(message.sender_id !== parseInt(userId))}>
                      ...
                      <div style={{
                        ...
                        opacity: '0.7',
                        marginTop: '5px',
                        textAlign: message.sender_id !== parseInt(userId) ? 'right' : 'left'
                      }}>
          ...
          <div style={{
            ...
            <div>
              <i className="fas fa-comments" style={{ fontSize: '4rem', marginBottom: '20px' }}></i>
              <h3 style={{ marginBottom: '10px', fontSize: '1.5rem' }}>Select a conversation</h3>
              <p style={{ fontSize: '1.1rem' }}>Choose a friend from the sidebar to start messaging</p>
            </div>
          </div>
        )}
      </div>
